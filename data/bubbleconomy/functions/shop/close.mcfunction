summon minecraft:armor_stand ^ ^-1.3 ^-.55 {NoGravity:1b, Invisible:1b, Small:1b, DisabledSlots:4144959, Tags:["buec.shop_shell", "-buec.notset"], Passengers:[{id:"minecraft:shulker", Tags:["buec.shell", "-buec.notset"], NoAI:1b, NoGravity:1b, Silent:1b, Invulnerable:1b, CustomName:'"Shop"', DeathLootTable:"minecraft:empty", Color:0b}]}
