...
execute if score @p bubbleconomy matches 1.. run scoreboard players remove @s buec.item_price 1
...
execute if score @p bubbleconomy matches 1.. run scoreboard players remove @s buec.item_price 10
...
execute if score @p bubbleconomy matches 1.. run scoreboard players remove @s buec.item_price 100
...
scoreboard players set @s[scores={buec.item_price=..-1}] buec.item_price 0
