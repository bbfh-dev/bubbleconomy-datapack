...
execute if score @s buec.gui_op matches 2 run data modify block 0 0 0 Text1 set value '["\'/trigger buec.auction\'. Current: ", {"score":{"name":"@e[type=minecraft:item_frame, tag=+buec.sign, limit=1]", "objective":"buec.auction"}, "color":"green", "extra":["β"]}]'
