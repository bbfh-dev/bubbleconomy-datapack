...
execute if score #Value bubbleconomy = #ID bubbleconomy run function bubbleconomy:database/write/add_balance_by_id_succeed
...
execute if score #Counter bubbleconomy matches 1.. run function bubbleconomy:database/write/add_balance_by_id_step