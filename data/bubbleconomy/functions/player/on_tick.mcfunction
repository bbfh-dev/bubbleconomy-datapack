...
execute if score @s buec.set_bid matches 0.. run function bubbleconomy:player/operation/auction
...
execute unless entity @e[type=minecraft:item_frame, tag=buec.shop, distance=..2] run scoreboard players reset @s buec.set_bid
